...
// The two if statments below arn't in the raw tf2 hud file, may need to be deleted		
			if_mvm
			{
				"wide"		"55"
				"tall"		"35"
...
//TournamentReadyHintIcon wasn't in the orignal hud files, may need to be ajusted (I just copy and pasted the raw version)
